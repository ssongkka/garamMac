...
public class RegularOperDTO {
	...
	public String getOperve() {
		return operve;
	}

	public void setOperve(String operve) {
		this.operve = operve;
	}
	...
	public String getRcmemo() {
		return rcmemo;
	}

	public void setRcmemo(String rcmemo) {
		this.rcmemo = rcmemo;
	}
