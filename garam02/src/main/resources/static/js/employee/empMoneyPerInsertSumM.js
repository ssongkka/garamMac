        ...
        for (let i = 0; i < aaa; i++) {
            ...
            switch ($(ttdd11).text()) {
                ...
                case "정기운행":
                    ...
                    sumReg = sumReg + parseInt(inpp3.replaceAll(',', ''));
                    break;
            }
        }
        $('#in-goM').text(AddComma(sumGy));
        $('#in-gitaM').text(AddComma(sumReg));
...
function sumOutList(result) {
    return new Promise(function (resolve, reject) {
        ...
        for (let i = 4; i < aaa; i++) {
            ...
            switch ($(ttdd1).text()) {
                case "대출":
                    const inpp3 = $(ttdd2).text();
                    sumDae = sumDae + parseInt(inpp3.replaceAll(',', ''));
                    break;
                case "차량보험":
                    const inpp4 = $(ttdd2).text();
                    sumChaBo = sumChaBo + parseInt(inpp4.replaceAll(',', ''));
                    break;
                case "기타":
        ...
        $('#out-gitaM1').text(AddComma(sumDae));
        $('#out-gitaM2').text(AddComma(sumChaBo));
...
function sumOut(result) {
    return new Promise(function (resolve, reject) {
        ...
        const outAll = parseInt(base) + parseInt(sadea) + parseInt(gita) +
                parseInt(sae);
...
function sumAll333(result) {
    return new Promise(function (resolve, reject) {
        ...
        const sumJan = parseInt($('#AllM1').text().replaceAll(',', '')) +
                parseInt($('#AllM').text().replaceAll(',', ''))

        $('#AllM2').text(AddComma(sumJan));
